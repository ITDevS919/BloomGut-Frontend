  ...
  return (
    <div className="bg-ivory min-h-full p-6 text-secondary">
      ...
      <div className="space-y-3">
        ...
        {/* Bind Email */}
        <button className="w-full mx-auto flex items-center justify-between gap-4 px-4 py-3 bg-white rounded-xl shadow-sm text-left" onClick={() => navigate('/setting/account/mailbox')}>
